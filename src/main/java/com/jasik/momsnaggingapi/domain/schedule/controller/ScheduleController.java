...
public class ScheduleController {
    ...
    public ResponseEntity<? extends BasicResponse> postSchedules(
        ...
        try {
            ...
            return ResponseEntity.created(uri).body(new CommonResponse<>(result));
    ...
    public ResponseEntity<? extends BasicResponse> getSchedules(
        @Schema(description = "사용자 ID", example = "1", required = true) @Parameter(name = "userId", description = "조회할 사용자 ID", in = ParameterIn.QUERY) @RequestParam Long userId,
        @Schema(description = "일자", example = "2022-04-16", required = true) @Parameter(name = "scheduleDate", description = "조회 일자", in = ParameterIn.QUERY) @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate scheduleDate) {
    ...
    public ResponseEntity<? extends BasicResponse> getSchedule(
        @Schema(description = "조회할 스케줄 ID", example = "2", required = true) @Parameter(name = "scheduleId", description = "조회할 스케줄 ID", in = ParameterIn.PATH) @PathVariable Long scheduleId) {
    ...
    public ResponseEntity<List<Schedule.ListResponse>> postSchedulesArray(
        ...
        List<Schedule.ListResponse> result = scheduleService.postSchedulesArray(
            scheduleArrayRequest);
